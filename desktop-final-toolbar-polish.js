(() => {
  if (window.__figureLoomDesktopFinalToolbarPolishV4) return;
  ...
  style.textContent = `
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .app-shell{grid-template-rows:43px 28px 53px minmax(0,1fr) 22px!important}
    ...
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body #settingsRibbonButton{order:-100!important;flex:0 0 auto!important;position:relative!important;top:0!important}
    ...
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .ribbon{height:53px!important;min-height:53px!important;gap:5px!important;padding:4px 9px!important;align-items:stretch!important;justify-content:stretch!important;overflow-y:hidden!important}
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .ribbon > .tool-group{flex:1 1 auto!important;min-width:0!important;gap:4px!important;padding:0 8px 8px 0!important;align-items:center!important;justify-content:space-evenly!important;min-height:0!important}
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .tool-group-label{bottom:0!important;font-size:7px!important;font-weight:600!important;line-height:1!important}
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .tool-group label{gap:3px!important;font-size:8.5px!important;font-weight:600!important;line-height:1!important}

    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .ribbon > .tool-group > :where(button,select,input:not([type="checkbox"]):not([type="radio"]):not([type="range"])){
      box-sizing:border-box!important;width:auto!important;min-width:0!important;max-width:150px!important;height:27px!important;min-height:27px!important;max-height:27px!important;margin:0!important;padding:0 clamp(6px,.55vw,10px)!important;border-radius:5px!important;box-shadow:none!important;font-size:8.75px!important;font-weight:620!important;letter-spacing:0!important;line-height:1!important;white-space:nowrap!important;overflow:visible!important;overflow-wrap:normal!important;text-align:center!important;vertical-align:middle!important
    }
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .ribbon .figureloom-desktop-compact-action{
      display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:1 1 auto!important;flex-basis:auto!important;width:auto!important;min-width:max-content!important;max-width:150px!important;height:27px!important;min-height:27px!important;max-height:27px!important;margin:0!important;padding:0 clamp(6px,.55vw,10px)!important;border-radius:5px!important;box-shadow:none!important;font-size:8.75px!important;font-weight:620!important;line-height:1!important;white-space:nowrap!important;overflow:visible!important;overflow-wrap:normal!important;text-align:center!important
    }
    ...
    html[data-figureloom-device-class="desktop"]:not([data-figureloom-larger-controls="1"]) body .ribbon :where(input[type="checkbox"],input[type="radio"]){width:13px!important;height:13px!important;min-width:13px!important;min-height:13px!important;margin:0!important}
