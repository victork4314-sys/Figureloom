...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request("./safe-refresh.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./settings-core.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./settings-page.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./desktop-density-mode.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./desktop-final-toolbar-polish.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./desktop-mode-tab-parity.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./desktop-settings-protools-final-fix.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./desktop-complete-consistency.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./today-ui-stability.js", { cache:"reload" })),
      cache.add(new Request("./today-ui-stability.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./passive-guide-expanded.js", { cache:"reload" })),
      cache.add(new Request("./passive-guide-expanded.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      ...
      cache.add(new Request("./mcp-settings-panel.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-simple-connect.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-settings-polish.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-command-extensions.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-feature-bootstrap.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-feature-adapters.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-security-overrides.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-office-command-adapter.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-hosted-only.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
      cache.add(new Request("./mcp-hosted-bridge.js?v=stable-71d36df-locked-20260720-v83", { cache:"reload" })),
