const FIGURELOOM_BUILD_ID = "stable-71d36df-locked-20260720-v65";
...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request("./safe-refresh.js?v=stable-71d36df-locked-20260720-v65", { cache:"reload" })),
      cache.add(new Request("./pptx-export-rebuilt.js", { cache:"reload" })),
      cache.add(new Request("./pptx-export-rebuilt.js?v=stable-71d36df-locked-20260720-v65", { cache:"reload" })),
      cache.add(new Request("./svg-all-pages-only.js", { cache:"reload" })),
      cache.add(new Request("./svg-all-pages-only.js?v=stable-71d36df-locked-20260720-v65", { cache:"reload" })),
