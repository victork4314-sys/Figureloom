(() => {
  if (window.__figureLoomStableRuntime71d36dfV36) return;
  window.__figureLoomStableRuntime71d36dfV36 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260719-v36";
