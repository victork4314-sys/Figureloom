(() => {
  if (window.__figureLoomStableRuntime71d36dfV17) return;
  window.__figureLoomStableRuntime71d36dfV17 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260718-v17";
