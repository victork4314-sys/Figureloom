(() => {
  if (window.__figureLoomStableRuntime71d36dfV27) return;
  window.__figureLoomStableRuntime71d36dfV27 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260719-v27";
