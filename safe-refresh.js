(() => {
  if (window.__figureLoomStableRuntime71d36dfV10) return;
  window.__figureLoomStableRuntime71d36dfV10 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260718-v10";
