(() => {
  ...
  style.textContent = `
    ...
    html[data-figureloom-resolved-mode="phone"] .ribbon.figureloom-phone-sheet-open{display:grid!important;grid-template-columns:minmax(0,1fr)!important;align-content:start!important;align-items:start!important;gap:10px!important;overflow-x:hidden!important;overflow-y:scroll!important;overscroll-behavior-y:contain!important;touch-action:pan-y!important;-webkit-overflow-scrolling:touch!important;scroll-behavior:auto;height:64dvh!important;padding-bottom:calc(104px + env(safe-area-inset-bottom))!important;scrollbar-gutter:stable}
    ...
    @media(orientation:landscape){html[data-figureloom-resolved-mode="phone"] .ribbon.figureloom-phone-sheet-open{height:78dvh!important}}
  `;
