...
Use the recipe Prepare bacterial sample.`)}
      ...
      <h3 id="browser-microbiology-methods">Browser microbiology methods</h3>
      <p>The browser methods are designed for examples, small local datasets, and quick exploration. Every result says which browser method ran. The same microbiology sentences still translate to the established native tools for full workflows.</p>
    `;
