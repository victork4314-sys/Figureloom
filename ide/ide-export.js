...
<head>
  ...
  <style>
    :root{color-scheme:light;--bg:#f4f7f6;--surface:#ffffff;--soft:#edf3f1;--strong:#dce9e5;--text:#172321;--muted:#60706c;--line:#cddbd7;--accent:#2f7468;--accent-strong:#195c51;--accent-soft:#dff1ec;--accent-ink:#ffffff;--shadow:0 12px 34px rgba(12,46,40,.12);--danger:#a43e3e;--danger-soft:#fae8e8;--warning:#8a641d;--warning-soft:#fff4d7}
    html[data-theme="dark"]{color-scheme:dark;--bg:#181d1c;--surface:#222927;--soft:#2a3431;--strong:#35413e;--text:#eef7f4;--muted:#aebdb8;--line:#43514d;--accent:#78c4b5;--accent-strong:#a1ddcf;--accent-soft:#253e38;--accent-ink:#102621;--shadow:0 12px 34px rgba(0,0,0,.34);--danger:#ff9b9b;--danger-soft:#482929;--warning:#f1ca73;--warning-soft:#44391f}
    *{box-sizing:border-box}
    ...
    .result-file strong{color:var(--accent-strong)}
    .result-file span{color:var(--muted);font-size:12px}
    .result-section.error{border-color:var(--danger);background:var(--danger-soft)}
    .result-section.error h3{color:var(--danger)}
    .result-section.warning{border-color:var(--warning);background:var(--warning-soft)}
    .result-section.warning h3{color:var(--warning)}
    footer{margin-top:22px;color:var(--muted);font-size:12px;text-align:center}
    @media print{html{color-scheme:light}:root,html[data-theme="dark"]{--bg:#fff;--surface:#fff;--soft:#f5f7f6;--text:#172321;--muted:#60706c;--line:#cddbd7;--accent:#2f7468;--accent-strong:#195c51;--accent-soft:#dff1ec;--shadow:none}body{background:#fff}main{width:100%;margin:0}.result-section,header{break-inside:avoid;box-shadow:none}}
  </style>
</head>
<body>
  <main>
